...
public class EmployeeControllerTest {
    ...
    public void should_return_the_employee_after_add_it() throws Exception {
        this.mockMvc.perform(put("/employees").contentType(MediaType.APPLICATION_JSON).content("{\"id\":4,\"name\":\"Xiaogang\",\"age\":16,\"gender\":\"MALE\"}"));

        String except = "[{\"id\":1,\"name\":\"Xiaoming\",\"age\":20,\"gender\":\"MALE\"},{\"id\":2,\"name\":\"Xiaohong\",\"age\":19,\"gender\":\"FEMALE\"},{\"id\":3,\"name\":\"Xiaozhi\",\"age\":15,\"gender\":\"MALE\"},{\"id\":4,\"name\":\"Xiaogang\",\"age\":16,\"gender\":\"MALE\"}]";
        this.mockMvc.perform(get("/employees")).andDo(print()).andExpect(status().isOk())
                .andExpect(content().string(is(except)));
    }
}